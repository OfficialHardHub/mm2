...
local PhantomForcesWindow = Library:NewWindow("MM2 DUPE")

local KillingCheats = PhantomForcesWindow:NewSection("DUPE")

KillingCheats:CreateButton("Dupe ALL", function()
...
local KillingCheats = PhantomForcesWindow:NewSection("Script by zflixy_")
